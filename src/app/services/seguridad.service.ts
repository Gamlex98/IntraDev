...
ConsultarCuentaUsuarioService(user:userModel):Observable<any>{
  console.log("Usuario a consultar en ConsultarCuentaUsuarioService: " + user.usuario);
  return this.http.get(`${this.urlLoopback}/usuarios/count?where={"usuario":"${user.usuario}"}`,
  {
...
listarUsuariosServicio(campo:string, orden:string):Observable<userModel[]>{
  let campoOrden = campo + " " + orden;
  console.log("listarUsuariosServicio -> campoOrden: " + campoOrden);
  return this.http.get<userModel[]>(`${this.urlLoopback}/usuarios?filter={"order": "${campoOrden}"}`);
...
BusquedaUsuariosServicio(buscar:string, campoBuscar:string):Observable<userModel[]>{
  ...
  return this.http.get<userModel[]>(`${this.urlLoopback}/usuarios?filter={"order": "id DESC", "where":{"${campoBuscar}":"${buscar}"}}`);
 ...
 SolicitarUser_id(id:string):Observable<any>{
  ...
  return this.http.get(`${this.urlLoopback}/usuarios/${id}`,
